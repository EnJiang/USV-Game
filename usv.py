...
class OneStepUSV(StaticUSV):
    ...
    def decision_algorithm(self):
        ...
        example_action = {'stay': False,
                         'clockwise': True, 'angular_speed': 90.0}
        example_action1 = {'stay': True, 'clockwise': True, 'angular_speed': 0}
        example_action2 = {'stay': False,
                          'clockwise': False, 'angular_speed': 270.0}
