...
if __name__ == '__main__':
    ...
    #方式2: matplotlib的画图, 但使用的是栅格化地图(画图时是按照格子来画，所以画的圆形是不规整的)
    #相应的代码在game.py中, MyContinueGame类的update函数中。 还有就是game.py最前面的头文件声明
    # recordEnvList = game.getRecordEnvList()
    #
    # for i in range(len(recordEnvList)):
    #     xlabels = []
    #     ylabels = []
    #     game.draw_heatmap(recordEnvList[i],xlabels,ylabels)
